...
const About=()=>{
    return (
        ...
        <div class="container pa2 ">
          ...
          <p><a class="btn btn-primary btn-lg w-40 grow" href="https://github.com/bisakhmondal" role="button" target='_blank'>About Me &raquo;</a></p>
          <p><a class="btn btn-primary btn-lg w-40 grow" href="https://github.com/bisakhmondal/meme-ranker" role="button" target='_blank'>
